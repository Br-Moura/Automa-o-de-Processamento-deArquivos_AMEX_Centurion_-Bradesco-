...
# Dados fixos para o produto: Banco Bradesco AMEX Centurion
STR_LAYOUT = 'C:\MATICA\MACHINE\MP_Layouts\AMEX_CENTURION.mpl'
STR_XML = 'C:\MATICA\MACHINE\MP_Databases\XML\AMEX_CENTURION\AMEX_CENTURION.xml'
STR_BD = 'C:\MATICA\MACHINE\MP_Databases\PRD\BRADESCO_AMEX_CENTURION'
STR_TITLE = ' ** AVISO ** ==> SELECIONE A DATA DO MOVIMENTO BANCO BRAD CENTURION'
...
def select_file():
    Tk().withdraw()
    initialdir_str = 'U:\PAYMENT\BRD\AMEX'
    title_str = STR_TITLE
...
def find_prd_file(file_fullname):
    ...
    MC_dir = 'U:\\PAYMENT\\BRD\\AMEX\\NXP\\CRD_DI' + dir_name[pos_date:]
